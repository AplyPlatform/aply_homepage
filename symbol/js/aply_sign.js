...
function processChange() {	
	var sigStr = `<div style="font-size: x-small; font-family:나눔고딕,NanumGothic,Sans-serif;" color="#777"><br><font color="#ddd" size="1">____________________________________________</font><br><br><br>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="240px"><tr><td>						
						<a href="https://aqr.aplx.link" target="_blank"><img src="https://home.aply.biz/assets/images/aqr_per.png" style="margin-right:26px;width:56px;" title="간편 송금을 지원하는 Link-in-bio 서비스"></a>
						<a href="https://aqr-m.aplx.link" target="_blank"><img src="https://home.aply.biz/assets/images/aqrm_per.png" style="margin-right:24px;width:48px;" title="QR코드 기반의 Mass production 관리 솔루션"></a>
						<a href="https://aplx.link" target="_blank"><img src="https://home.aply.biz/assets/images/aplx_per.png" style="width:48px;" title="증강현실 기반의 홍보/전시/커뮤니케이션 플랫폼"></a>
					</td>
					</tr>
					</table>
					<br><br>
